import { T as Timer$1, t as timer$1, n as now$1, c as cubicInOut$1 } from './common/cubic-263021a1.js';
import { r as reinterpolate, v as color$1, q as interpolateRgb, w as interpolateString, i as interpolateValue } from './common/utcMonth-4ccdc574.js';
import { k as ascending$3, m as tickIncrement, t as ticks, n as bisectRight, j as tickStep } from './common/linear-6238e9df.js';
export { F as FormatSpecifier, k as ascending, n as bisect, p as bisectCenter, o as bisectLeft, n as bisectRight, h as bisector, f as format, q as formatDefaultLocale, s as formatLocale, r as formatPrefix, u as formatSpecifier, v as precisionFixed, w as precisionPrefix, x as precisionRound, l as scaleLinear, y as tickFormat, m as tickIncrement, j as tickStep, t as ticks } from './common/linear-6238e9df.js';
import { A as Adder, m as merge } from './common/merge-2c89d5e0.js';
export { A as Adder, f as fsum, m as merge } from './common/merge-2c89d5e0.js';
import { r as range$2 } from './common/band-5eb4d7ba.js';
export { r as range, b as scaleBand, p as scalePoint } from './common/band-5eb4d7ba.js';
import { q as quantile, m as min$2 } from './common/diverging-dee6d460.js';
export { m as min, q as quantile, a as quantileSorted, b as quickselect, e as scaleDiverging, f as scaleDivergingLog, g as scaleDivergingPow, h as scaleDivergingSqrt, j as scaleDivergingSymlog, i as scaleIdentity, c as scaleQuantile, d as scaleQuantize, r as scaleRadial, s as scaleSequentialQuantile, t as scaleThreshold, u as scaleUtc } from './common/diverging-dee6d460.js';
export { l as scaleLog, p as scalePow, s as scaleSequential, c as scaleSequentialLog, d as scaleSequentialPow, e as scaleSequentialSqrt, f as scaleSequentialSymlog, b as scaleSqrt, a as scaleSymlog } from './common/sequential-b827d1b6.js';
import { u as utcFormat, a as utcParse } from './common/defaultLocale-8f6062a7.js';
export { t as timeFormat, d as timeFormatDefaultLocale, f as timeFormatLocale, b as timeParse, u as utcFormat, a as utcParse } from './common/defaultLocale-8f6062a7.js';
import { e as extent$1 } from './common/extent-64083604.js';
export { e as extent } from './common/extent-64083604.js';
import { m as max$3 } from './common/max-1b484d11.js';
export { m as max } from './common/max-1b484d11.js';
import { p as path$1 } from './common/path-ebc45f0e.js';
export { i as scaleImplicit, o as scaleOrdinal } from './common/ordinal-65ab6804.js';
export { t as scaleTime } from './common/time-fb11ae4c.js';
import { ai as colors } from './common/viridis-c59cbebd.js';
export { T as interpolateBlues, K as interpolateBrBG, a4 as interpolateBuGn, a5 as interpolateBuPu, a2 as interpolateCool, a3 as interpolateCubehelixDefault, a6 as interpolateGnBu, U as interpolateGreens, V as interpolateGreys, _ as interpolateInferno, $ as interpolateMagma, a7 as interpolateOrRd, W as interpolateOranges, L as interpolatePRGn, M as interpolatePiYG, a0 as interpolatePlasma, a9 as interpolatePuBu, a8 as interpolatePuBuGn, N as interpolatePuOr, aa as interpolatePuRd, X as interpolatePurples, ag as interpolateRainbow, O as interpolateRdBu, P as interpolateRdGy, ab as interpolateRdPu, Q as interpolateRdYlBu, R as interpolateRdYlGn, Y as interpolateReds, ah as interpolateSinebow, S as interpolateSpectral, Z as interpolateViridis, a1 as interpolateWarm, ad as interpolateYlGn, ac as interpolateYlGnBu, ae as interpolateYlOrBr, af as interpolateYlOrRd, B as schemeAccent, h as schemeBlues, J as schemeBrBG, n as schemeBuGn, o as schemeBuPu, A as schemeCategory10, C as schemeDark2, p as schemeGnBu, i as schemeGreens, j as schemeGreys, q as schemeOrRd, k as schemeOranges, s as schemePRGn, D as schemePaired, E as schemePastel1, F as schemePastel2, a as schemePiYG, t as schemePuBu, r as schemePuBuGn, b as schemePuOr, u as schemePuRd, l as schemePurples, c as schemeRdBu, d as schemeRdGy, v as schemeRdPu, e as schemeRdYlBu, f as schemeRdYlGn, m as schemeReds, G as schemeSet1, H as schemeSet2, I as schemeSet3, g as schemeSpectral, x as schemeYlGn, w as schemeYlGnBu, y as schemeYlOrBr, z as schemeYlOrRd } from './common/viridis-c59cbebd.js';
...
function transpose(matrix) {
  ...
  for (var i = -1, m = min$2(matrix, length$1), transpose = new Array(m); ++i < m;) {
...
function rotationIdentity(lambda, phi) {
  return [abs$2(lambda) > pi$2 ? lambda + Math.round(-lambda / tau$3) * tau$3 : lambda, phi];
}
...
function longitude(point) {
  if (abs$2(point[0]) <= pi$2)
    return point[0];
  else
    return sign(point[0]) * ((abs$2(point[0]) + pi$2) % tau$3 - pi$2);
}
...
function graticule() {
  ...
  function lines() {
    return range$2(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(range$2(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$2(x % DX) > epsilon$3; }).map(x))
        .concat(range$2(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$2(y % DY) > epsilon$3; }).map(y));
  }
  ...
  function resampleLineTo(x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1, b1, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a = a0 + a1,
          ...
          m = sqrt(a * a + b * b + c * c),
          phi2 = asin(c /= m),
          lambda2 = abs$2(abs$2(c) - 1) < epsilon$3 || abs$2(lambda0 - lambda1) < epsilon$3 ? (lambda0 + lambda1) / 2 : atan2(b, a),
...
function hue(a, b) {
  var d = b - a;
  return d ? linear$1(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$9(isNaN(a) ? b : a);
}

function gamma(y) {
  return (y = +y) === 1 ? nogamma : function(a, b) {
    return b - a ? exponential(a, b, y) : constant$9(isNaN(a) ? b : a);
  };
}

function nogamma(a, b) {
  var d = b - a;
  return d ? linear$1(a, d) : constant$9(isNaN(a) ? b : a);
}
...
function parseCss$1(value) {
  ...
  return m.isIdentity ? identity$5 : decompose$1(m.a, m.b, m.c, m.d, m.e, m.f);
}
      ...
      if (rc > epsilon$5) {
        ...
        if (da < pi$4 && (oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10))) {
          var ax = x01 - oc[0],
              ...
              bx = x11 - oc[0],
              by = y11 - oc[1],
              kc = 1 / sin$2(acos$1((ax * bx + ay * by) / (sqrt$1(ax * ax + ay * ay) * sqrt$1(bx * bx + by * by))) / 2),
